...
<body>
    ...
    <div id="backSlider">
        ...
        <div class="slider">
            <ul>
                <li>
                    <a href="ver_producto.php?id=16&t=0"><img src="../productos/slider/Hot-Sale-todos-hablan-de-so.png" alt=""></a>
                </li>
                <li>
                    <a href="ver_producto.php?id=2&t=0"><img src="../productos/slider/slider-hot-sale-paypal-doto-Mexico-2020_1_.jpg" alt="">
                </li>
                <li>
                    <a href="ver_producto.php?id=1&t=0"> <img src="../productos/slider/Xiaomi-Mi-9T-mas-bar.jpg" alt="">
                </li>
                <li>
                    <a href="ver_producto.php?id=17&t=0"> <img src="../productos/slider/Xiaomi-Redmi-Note-9-Pro-ofco.jpg" alt="">
                </li>
            </ul>
        </div>
    </div>
