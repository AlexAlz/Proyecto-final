	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="loginBox">
						<img src="images/Inicio.png" class="img-responsive" style="max-width: 100px;" alt="PHP MySQL logos">
						<h2>Login</h2>
					...
					?>
					<br><br><a href="clientes/formulario_cliente_no_login.php">Crear cuenta</a>
				</div><!-- /.card -->
			</div><!-- /.col -->
		</div>
		<!--/.row-->
